...
def Task4a():
    ...
    print("The probability of a Noun(PP) being 'I' is", tagwords["NN"].prob("we"))
    print("The probability of a 'VB' following a 'PP' is", tagwords["VB"].prob("like"))    
...
#################################################################################################################################
def Task4b():
    prob = prob("PP") * prob("VB") * prob("PP") * prob("NN")
    prob2 = tagwords["PP"].prob("I")*tagwords["VB"].prob("conduct")*tagwords["PP"].prob("my")*tagwords["NN"].prob("conduct")
    return prob, prob2
...
def Task4c():
    ...
    return ViterbiBestTag(distinct_tags, tagwords, tags, sentence)
print(Task4c())
